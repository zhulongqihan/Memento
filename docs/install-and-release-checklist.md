...
6. 安装下一版本覆盖升级，确认旧版本数据可打开；再从系统设置卸载，确认卸载完成且不误删用户主动保留的备份文件。
7. 检查 1280、1440、1920 桌面宽度；使用键盘 Tab、Enter、Escape 完成打开、保存和关闭。
8. 发布后新增 `docs/reviews/vX.Y.Z.md`，写明已验证项、未验证项、风险等级和下一轮优先级。
